  ...
  (keymap (normal (l ":move-char-right-same-line")
                  ...
                  (d (d ":vim-delete-line")
                     ...
                     (a (w ":vim-delete-around-word")
                        ...
                        (t ":vim-delete-around-html-tag")
                        (x ":vim-delete-around-type-definition")
                     ...
                     (i (w ":vim-delete-inner-word")
                        ...
                        (t ":vim-delete-inner-html-tag")
                        (x ":vim-delete-inner-type-definition")
                  ...
                  (c (c ":vim-change-line")
                     ...
                     (a (w ":vim-change-around-word")
                        ...
                        (t ":vim-change-around-html-tag")
                        (x ":vim-change-around-type-definition")
                     ...
                     (i (w ":vim-change-inner-word")
                        ...
                        (t ":vim-change-inner-html-tag")
                        (x ":vim-change-inner-type-definition")
                  ...
                  (y (y ":vim-yank-line")
                     ...
                     (a (w ":yank-around-word")
                        ...
                        (t ":yank-around-html-tag")
                        (x ":yank-around-type-definition")
                        (T ":yank-around-test")
                        ("{" ":yank-around-curly")
                        ("[" ":yank-around-square")
                        ("(" ":yank-around-paren")
                     ...
                     (i (w ":yank-inner-word")
                        ...
                        (t ":yank-inner-html-tag")
                        (x ":yank-inner-type-definition")
                        (T ":yank-inner-test")
                        ("{" ":yank-inner-curly")
                        ("[" ":yank-inner-square")
                        ("(" ":yank-inner-paren")
          ...
          (select (a (w ":select-around-word")
                     ...
                     (t ":select-around-html-tag")
                     (x ":select-around-type-definition")
                  ...
                  (i (w ":select-inner-word")
                     ...
                     (t ":select-inner-html-tag")
                     (x ":select-inner-type-definition")
                     (T ":select-inner-test")
                     ("{" ":select-inner-curly")
                     ("[" ":select-inner-square")
                     ("(" ":select-inner-paren")
...
;; Priority-override keymap for VIS-LINE steel mode. Only the keys that differ
;; from regular select mode are listed here; everything else falls through to
;; the buffer keymap (the full vim select bindings registered above).
(define vis-line-keymap
  (keymap (select (j ":extend-line-down-vis-line")
                  (k ":extend-line-up-vis-line")
                  (down ":extend-line-down-vis-line")
                  (up ":extend-line-up-vis-line")
                  (esc ":exit-visual-line-mode"))))

(define (set-vim-keybindings!)
  (add-global-keybinding vim-keybindings)
  (register-steel-mode-keymap! "VIS-LINE" vis-line-keymap))
